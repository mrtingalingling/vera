...
import { piiScrubber } from './piiScrubberService.js';

describe('Layer 1.2: Private Messaging Add-on & Local PII Scrubber in Vera', () => {
  it('scrubs emails, phone numbers, and handles from private messages on-device', () => {
    const raw = 'Hey Dave, email me at doctor.smith@clinic.org or call +1-555-837-1234. Ping @dr_smith on telegram.';
