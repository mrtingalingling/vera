 ...
 * Running on-device within the Vera Browser Extension and core engine.
 * Designed for WhatsApp Web, Telegram Web, Signal, and WeChat Web.
 * Guarantees zero-data-leakage client-side sanitization prior to local or cloud verification.
 */
